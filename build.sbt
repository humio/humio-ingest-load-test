...
libraryDependencies += "io.gatling.highcharts" % "gatling-charts-highcharts" % "3.9.5"
libraryDependencies += "io.gatling"            % "gatling-test-framework"    % "3.9.5"
libraryDependencies += "io.gatling"            % "gatling-core"    % "3.9.5"
